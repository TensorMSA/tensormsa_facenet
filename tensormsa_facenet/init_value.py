...
import tensormsa_facenet.src.common.download_and_extract as download_and_extract
import tensormsa_facenet.src.common.utils as utils
...
class init_value():
    def init(self):
        ...
        self.pair_type = 'distance_sub'  # svm, svm_pair, cnn_pair, distance_sub, distance_cos

        self.project_dir = os.path.dirname(os.path.abspath(__file__)) + '/'
        self.parent_project_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) + '/'
        self.common_sets_dir = self.parent_project_dir + 'common_sets/'
        ...
        self.pre_data_dir = self.common_sets_dir + 'datasets/'
        ...
        self.font_location = self.common_sets_dir + 'font/ttf/NanumBarunGothic.ttf'
